		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapbyjusbyjusdashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbyjusbyjusdashboard-display": {
								"semanticObject": "comsapbyjusbyjusdashboard",
								"action": "display",
								"description": "Byjus Finance Dashbaord",
								"title": "Finance Dashboard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.byjus.byjusdashboard",
									"url": sap.ui.require.toUrl("com/sap/byjus/byjusdashboard")
								}
							}
						}
					}
